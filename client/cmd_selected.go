...
func (c *Client) fetch(uid bool, seqset *imap.SeqSet, items []imap.FetchItem, ch chan *imap.Message, changedSince uint32) error {
	defer close(ch)
...
func (c *Client) Fetch(seqset *imap.SeqSet, items []imap.FetchItem, ch chan *imap.Message, changedSince uint32) error {
	return c.fetch(false, seqset, items, ch, changedSince)
}
...
func (c *Client) UidFetch(seqset *imap.SeqSet, items []imap.FetchItem, ch chan *imap.Message, changedSince uint32) error {
	return c.fetch(true, seqset, items, ch, changedSince)
}
